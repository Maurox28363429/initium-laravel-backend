...
class CreateHistorialCursoClientsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('historial_curso_clients', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('historial_curso_clients');
    }
}
