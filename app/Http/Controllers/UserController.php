...
/*             $envio = $this->sendMail($user->email, 30547075, [
            ...
            $html_send="<div align='center'>
                <img src='https://initium.phoenixtechsa.com/assets/images/logo-login.png' style='width:300px;margin:auto'>
                </div>
                <h2>Codigo de recuperacion</h2>
                <p>Hola ".$user->name."</p>
                <p>Has solicitado restablecer tu contrasena introduce el siguiente codigo en el APP</p>
                <h1 style='text-align:center'>Codigo: ".$user->recovery_cod."</h1>
                </div>
            ";
            $json_data=[
                "email" => "info@mauricioreyesdev.com",
                "to" => $user->email,
                "subject" => "Codigo para la recuperaci«Ñn de su cuenta",
                "html" => utf8_encode($html_send)
            ];
            Http::asForm()->post('https://yappymicroservicio.phoenixtechsa.com/mailer',$json_data);
            return [
    ...
    public function authenticate_participante(Request $request)
    {
        ...
        return response()->json(compact('token', 'user', 'ttl'));
    }
